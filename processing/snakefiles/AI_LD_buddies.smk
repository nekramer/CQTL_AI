...
rule getLDbuddy_rsIDs:
    ...
    shell:
        ...
        python3 scripts/AI_LD_buddies/AI_LD_buddies_RSIDs.py /work/users/n/e/nekramer/Data/CQTL/AI/freeze/LD_buddies/{wildcards.snp}_{wildcards.condition}_0.8.ld {wildcards.snp} {wildcards.condition}
        """
...
rule join_LDbuddies:
    ...
    shell:
        """
        module load r/4.1.3
        Rscript scripts/AI_LD_buddies/join_LDbuddies.R {input.rsids} {input.positions} {wildcards.snp} {wildcards.condition}
        """
...
rule join_conditionLDbuddies:
    ...
    shell:
        """
        module load r/4.1.3
        Rscript scripts/AI_LD_buddies/join_allLD_buddies.R {wildcards.condition} {input}
        """